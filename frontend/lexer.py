...
reserved = (
    'extern', 'static',
    'if', 'else', 'while', 'do', 'for','to', #!added while, do, for and to. break & continue also added
...
tokens = (
    ...
    'TYPE',
    'MODIFY',
    'BOOLCONST', 'CHARCONST', 'INTCONST', 'HEXCONST', 'FLOATCONST', #! added Floatconst
    'STRINGCONST',
    'DOTS',
    'ID',
...
reserved_map['float'] = 'TYPE' #! added 'float'
